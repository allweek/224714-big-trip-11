...
const createTripDay = (date, dayCount) => {
  const monthShortName = date ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getMonthShortName"])(date) : ``;
  const dateTime = date ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatDateWithHyphen"])(date) : ``;
...
class Options extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(options) {
    super();
...
const pointTypesGroups = getAllPointTypes(_const__WEBPACK_IMPORTED_MODULE_4__["PointTypes"]);
  ...
  return (
    `<div class="event__type-item">
      ...
      <label
        ...
        for="event-type-${pointType.name}-${dayCount}">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_7__["capitalizeWord"])(pointType.name)}
      </label>
    </div>`
  );
};
...
const createPointEditTemplate = (currentPoint, offers, destinations, externalData, dayCount, isCreatingNew) => {
  ...
  const priceSanitized = price ? Object(he__WEBPACK_IMPORTED_MODULE_3__["encode"])(price.toString()) : ``;
  ...
  const pointNameToCapitalize = pointType.name ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_7__["capitalizeWord"])(pointType.name) : ``;
  ...
  if (offers) {
    ...
    if (offersWithCheckedFlag) {
      const offersComponent = new _offers__WEBPACK_IMPORTED_MODULE_2__["default"](offersWithCheckedFlag, dayCount);
      offersMarkup = offersComponent.getTemplate();
    }
  }


  const pointTypesGroupsMarkup = createPointTypeGroupsMarkup(_const__WEBPACK_IMPORTED_MODULE_4__["PointTypes"], dayCount, pointType.name);


  const destinationMarkup = destination ? new _destination__WEBPACK_IMPORTED_MODULE_1__["default"](destination).getTemplate() : ``;
...
class PointEdit extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  applyFlatpickr() {
    ...
    this._flatpickrFrom = flatpickr__WEBPACK_IMPORTED_MODULE_5___default()(dateStartElement, {
      allowInput: true,
    ...
    this._flatpickrTo = flatpickr__WEBPACK_IMPORTED_MODULE_5___default()(dateEndElement, {
      allowInput: true,
  ...
  _subscribeOnEvents() {
    ...
    Array.from(element.querySelectorAll(`.event__type-group`)).forEach((fieldset) => {
      fieldset.addEventListener(`change`, (evt) => {
        ...
        this._currentPoint.pointType = Object(_utils_common__WEBPACK_IMPORTED_MODULE_7__["matchPointType"])(pointName);
    ...
    element.addEventListener(`change`, () => {
      ...
      const dateStart = Object(_utils_common__WEBPACK_IMPORTED_MODULE_7__["formatFromStringToDate"])(dateStartString);
      const dateEndString = formData.get(`event-end-time`);
      const dateEnd = Object(_utils_common__WEBPACK_IMPORTED_MODULE_7__["formatFromStringToDate"])(dateEndString);
...
const createPointMarkup = (point) => {
  ...
  const pointNameToCapitalize = pointType.name ? Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["capitalizeWord"])(pointType.name) : ``;
  const timeStartFormatted = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["formatTime"])(dateStart);
  const timeEndFormatted = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["formatTime"])(dateEnd);
  const durationFormatted = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getDurationFormatted"])(dateStart, dateEnd);

  const preposition = pointType.group === `Transfer` ? `to` : `in`;
  const dateTimeStart = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["formatDateWithHyphenTime"])(dateStart);
  const dateTimeEnd = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["formatDateWithHyphenTime"])(dateEnd);
    ...
    `<li class="trip-events__item">
      <div class="event">
        ...
        <div class="event__schedule">
          ...
          ${(new _options__WEBPACK_IMPORTED_MODULE_1__["default"](offersChecked)).getTemplate()}          
...
class Point extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(point) {
    super();
    this._point = point;
  }
...
class Preloader extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    ...
    options: {
      plugins: {
        datalabels: {
          ...
          anchor: `end`,
          align: `start`,
          formatter: (val) => `${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["getDurationFormatted"])(0, val)}`
        }
      },
      title: {
        display: true,
...
const getTransport = (points) => {
  return points.reduce((transport, point) => {
    const transportKind = _const__WEBPACK_IMPORTED_MODULE_4__["PointTypesEmojiMapping"][point.pointType.name];
...
const getMoneyByPointTypes = (points) => {
  return points.reduce((money, point) => {
    const pointType = _const__WEBPACK_IMPORTED_MODULE_4__["PointTypesEmojiMapping"][point.pointType.name];
    if (money[pointType]) {
...
const createTripInfoMain = (points) => {
  ...
  const oldestPointMonth = oldestPoint ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getMonthShortName"])(oldestPoint.dateStart) : ``;
  const oldestPointDay = oldestPoint ? oldestPoint.dateStart.getDate() : ``;
  const newestPointMonth = newestPoint ? Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getMonthShortName"])(newestPoint.dateEnd) : ``;
...
class Trip extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: FilterType, SortType, MenuItem, PointTypes, PointTypesEmojiMapping, defaultPointType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PointTypesEmojiMapping", function() { return PointTypesEmojiMapping; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "defaultPointType", function() { return defaultPointType; });
const FilterType = {
...
const defaultPointType = PointTypes[0];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Days; });
/* harmony import */ var _components_days__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/days */ "./src/components/days.js");
...
class Days {
  ...
  render() {
    ...
    this._daysComponent = new _components_days__WEBPACK_IMPORTED_MODULE_0__["default"]();

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._daysComponent, container, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
  }
...
class Filter {
  constructor(container, pointsModel) {
    ...
    this._activeFilterType = _const__WEBPACK_IMPORTED_MODULE_2__["FilterType"].EVERYTHING;
  ...
  render() {
    ...
    const filters = Object.values(_const__WEBPACK_IMPORTED_MODULE_2__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
        isChecked: filterType === this._activeFilterType,
        isDisabled: !Object(_utils_filter__WEBPACK_IMPORTED_MODULE_3__["getPointsByFilter"])(allPoints, filterType).length
      };
    });
    ...
    if (oldComponent) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterComponent, container, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
    }
  }
...
/* harmony import */ var _components_point_edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/point-edit */ "./src/components/point-edit.js");
...
const parseFormData = (form, offers, destinations) => {
  ...
  const dateStartString = formData.get(`event-start-time`);
  const dateStart = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatFromStringToDate"])(dateStartString);
  const dateEndString = formData.get(`event-end-time`);
  const dateEnd = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatFromStringToDate"])(dateEndString);
  ...
  return new _models_point__WEBPACK_IMPORTED_MODULE_2__["default"]({
...
const EmptyPoint = {
  pointType: _const__WEBPACK_IMPORTED_MODULE_5__["defaultPointType"],
  destination: null,
  price: null,
  dateStart: new Date(),
  dateEnd: new Date(),
...
class Point {
  ...
  render(point, mode) {
    ...
    this._pointEditComponent = new _components_point_edit__WEBPACK_IMPORTED_MODULE_1__["default"](point, this._offers, this._destinations, this._dayCount, isCreatingNew);
    ...
    this._pointEditComponent.setFavoritesButtonClickHandler(() => {
      const newPoint = _models_point__WEBPACK_IMPORTED_MODULE_2__["default"].clone(point);
    ...
    switch (mode) {
      case Mode.DEFAULT:
        if (oldPointComponent && oldPointEditComponent) {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._pointComponent, oldPointComponent);
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._pointEditComponent, oldPointEditComponent);
          this._replaceEditToPoint();
        } else {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["render"])(this._pointComponent, this._container, _utils_render__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
        }
        break;
      case Mode.ADDING:
        if (oldPointComponent && oldPointEditComponent) {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["remove"])(oldPointComponent);
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["remove"])(oldPointEditComponent);
        }
        document.addEventListener(`keydown`, this._onEscKeyDown);
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["render"])(this._pointEditComponent, this._container, _utils_render__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].AFTERBEGIN);
  ...
  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._pointEditComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._pointComponent);
    document.removeEventListener(`keydown`, this._onEscKeyDown);
  }
  ...
  _replacePointToEdit() {
    this._onViewChange();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._pointEditComponent, this._pointComponent);
    this._pointEditComponent.applyFlatpickr();
  ...
  _replaceEditToPoint() {
    ...
    if (document.contains(this._pointEditComponent.getElement())) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._pointComponent, this._pointEditComponent);
    }
...
class TripInfo {
  ...
  render() {
    ...
    this._tripInfoComponent = new _components_trip_info__WEBPACK_IMPORTED_MODULE_0__["default"](allPoints);

    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._tripInfoComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._tripInfoComponent, container, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);
    }
  }
...
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/common */ "./src/utils/common.js");
/* harmony import */ var _controllers_point__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/point */ "./src/controllers/point.js");
...
/* harmony import */ var _controllers_days__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../controllers/days */ "./src/controllers/days.js");
/* harmony import */ var _components_day__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/day */ "./src/components/day.js");
/* harmony import */ var _components_preloader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/preloader */ "./src/components/preloader.js");
/* harmony import */ var _components_no_points__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/no-points */ "./src/components/no-points.js");
...
const renderPointsWithDays = (dayList, points, offers, destinations, onDataChange, onViewChange) => {
  ...
  sortedPoints
    ...
    .forEach((pointsByDay, index) => {
      ...
      const day = new _components_day__WEBPACK_IMPORTED_MODULE_5__["default"](date, dayCount);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(day, dayList, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      const pointsList = day.getElement().querySelector(`.trip-events__list`);
      pointControllers = [...pointControllers,
        ...(pointsByDay.points
          .map((point) => {
            const pointController = new _controllers_point__WEBPACK_IMPORTED_MODULE_2__["default"](pointsList, offers, destinations, onDataChange, onViewChange, dayCount);

            pointController.render(point, _controllers_point__WEBPACK_IMPORTED_MODULE_2__["Mode"].DEFAULT);
...
const renderPointsWithoutDays = (dayList, points, offers, destinations, onDataChange, onViewChange) => {
  const day = new _components_day__WEBPACK_IMPORTED_MODULE_5__["default"]();
  Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(day, dayList, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
  const pointsList = day.getElement().querySelector(`.trip-events__list`);

  return points.map((point) => {
    const pointController = new _controllers_point__WEBPACK_IMPORTED_MODULE_2__["default"](pointsList, offers, destinations, onDataChange, onViewChange, null);
...
const getSortedPoints = (points, sortType) => {
  let sortedPoints = [];
  switch (sortType) {
    case _const__WEBPACK_IMPORTED_MODULE_8__["SortType"].EVENT:
      sortedPoints = points;
      break;
    case _const__WEBPACK_IMPORTED_MODULE_8__["SortType"].TIME:
      sortedPoints = points.sort((a, b) => (Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(b.dateStart, b.dateEnd)) - (Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["getDuration"])(a.dateStart, a.dateEnd)));
      break;
    case _const__WEBPACK_IMPORTED_MODULE_8__["SortType"].PRICE:
...
class Trip {
  constructor(container, pointsModel, api) {
    ...
    this._preloader = new _components_preloader__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this._noPointsComponent = new _components_no_points__WEBPACK_IMPORTED_MODULE_7__["default"]();
    this._onDataChange = this._onDataChange.bind(this);
  ...
  setDefaultSortType() {
    this._setSortType(_const__WEBPACK_IMPORTED_MODULE_8__["SortType"].EVENT);
  }
  ...
  createPoint(newPointButton) {
    ...
    this._creatingPoint = new _controllers_point__WEBPACK_IMPORTED_MODULE_2__["default"](dayListElement, this._offers, this._destinations, this._onDataChange, this._onViewChange, 0);
    this._creatingPoint.render(_controllers_point__WEBPACK_IMPORTED_MODULE_2__["EmptyPoint"], _controllers_point__WEBPACK_IMPORTED_MODULE_2__["Mode"].ADDING);

    // если список пуст и создается первый event
    if (!document.contains(this._sortComponent.getElement())) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._sortComponent, this._container.getElement(), _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
    }
  }
  ...
  render() {
    ...
    this._daysController = new _controllers_days__WEBPACK_IMPORTED_MODULE_4__["default"](container);
    ...
    if (!points.length) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._sortComponent, container, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
  ...
  showPreloader() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._preloader, container, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
  }

  _removePreloader() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._preloader);
  ...
  _renderPoints(points) {
    ...
    let newPoints;
    if (this._sortComponent.getSortType() === _const__WEBPACK_IMPORTED_MODULE_8__["SortType"].EVENT) {
  ...
  _removeNoPoints() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._noPointsComponent);
  ...
  _showNoPoints() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._noPointsComponent, container, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
  }
  ...
  _onDataChange(pointController, oldData, newData, stayOnAddingMode) {
    if (oldData === _controllers_point__WEBPACK_IMPORTED_MODULE_2__["EmptyPoint"]) {
      this._creatingPoint = null;
      if (newData === null) {
        ...
        .then((pointModel) => {
          ...
          if (isSuccess) {
            if (stayOnAddingMode) {
              ...
              pointController.render(newData, _controllers_point__WEBPACK_IMPORTED_MODULE_2__["Mode"].ADDING);
            } else {
...
/* harmony import */ var _models_points_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/points.js */ "./src/models/points.js");
...
/* harmony import */ var _controllers_trip_info__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/trip-info */ "./src/controllers/trip-info.js");
/* harmony import */ var _components_stats__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/stats */ "./src/components/stats.js");
...
/* harmony import */ var _controllers_trip_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./controllers/trip.js */ "./src/controllers/trip.js");
...
const AUTHORIZATION = `Basic eo0w590ik22789a=`;
const END_POINT = `https://11.ecmascript.pages.academy/big-trip`;

const api = new _api_js__WEBPACK_IMPORTED_MODULE_0__["default"](END_POINT, AUTHORIZATION);
const pointsModel = new _models_points_js__WEBPACK_IMPORTED_MODULE_2__["default"]();


const tripMain = document.querySelector(`.trip-main`);
const tripInfoController = new _controllers_trip_info__WEBPACK_IMPORTED_MODULE_4__["default"](tripMain, pointsModel);
tripInfoController.render();

const tripControls = tripMain.querySelector(`.trip-controls`);
const menuComponent = new _components_menu__WEBPACK_IMPORTED_MODULE_6__["default"]();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(menuComponent, tripControls, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].AFTERBEGIN);

const newPointButton = tripMain.querySelector(`.trip-main__event-add-btn`);

const filterController = new _controllers_filter__WEBPACK_IMPORTED_MODULE_3__["default"](tripControls, pointsModel);
filterController.render();

const tripComponent = new _components_trip_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const tripController = new _controllers_trip_js__WEBPACK_IMPORTED_MODULE_9__["default"](tripComponent, pointsModel, api);
tripController.showPreloader();
newPointButton.disabled = true;

const container = document.querySelectorAll(`.page-body__container`)[1];
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(tripComponent, container, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);

const statComponent = new _components_stats__WEBPACK_IMPORTED_MODULE_5__["default"]({points: pointsModel});
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(statComponent, container, _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["RenderPosition"].BEFOREEND);
statComponent.hide();

newPointButton.addEventListener(`click`, () => {
  statComponent.hide();
  menuComponent.setActiveItem(_const__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].TABLE);
  tripController.show();
  newPointButton.disabled = true;
...
menuComponent.setOnChange((menuItem) => {
  switch (menuItem) {
    ...
    case _const__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].STATISTICS:
      menuComponent.setActiveItem(_const__WEBPACK_IMPORTED_MODULE_7__["MenuItem"].STATISTICS);
      tripController.hide();
...
class Point {
  constructor(data) {
    this.id = data[`id`];
    this.pointType = Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["matchPointType"])(data[`type`]);
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: formatTime, formatDateWithHyphen, formatDateWithHyphenTime, formatFromStringToDate, getDuration, castTimeFormat, getDurationFormatted, getMonthShortName, matchPointType, capitalizeWord */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatTime", function() { return formatTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateWithHyphen", function() { return formatDateWithHyphen; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatDateWithHyphenTime", function() { return formatDateWithHyphenTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatFromStringToDate", function() { return formatFromStringToDate; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDurationFormatted", function() { return getDurationFormatted; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMonthShortName", function() { return getMonthShortName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "matchPointType", function() { return matchPointType; });
...
const formatDateWithHyphenTime = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`YYYY-MM-DDTHH:mm`);
};

const formatFromStringToDate = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date, `DD/MM/YY HH:mm`).toDate();
};

const getDuration = (start, end) => {
  const diff = moment__WEBPACK_IMPORTED_MODULE_0___default()(end).diff(moment__WEBPACK_IMPORTED_MODULE_0___default()(start));
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(diff);
};
...
const getDurationFormatted = (start, end) => {
  const diff = moment__WEBPACK_IMPORTED_MODULE_0___default()(end).diff(moment__WEBPACK_IMPORTED_MODULE_0___default()(start));
...
const matchPointType = (pointName) => {
  return Object.assign({}, _const__WEBPACK_IMPORTED_MODULE_1__["PointTypes"].find((point) => point.name === pointName));
};
